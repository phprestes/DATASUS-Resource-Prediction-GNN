...
- **[docs/03-decisoes.md](docs/03-decisoes.md)** — 37 numbered decisions with the evidence behind each and what was rejected. When something in the code looks surprising, the reason is usually a D-nn entry.
